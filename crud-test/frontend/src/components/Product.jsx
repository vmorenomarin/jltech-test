...
export const Product = () => {
  return (
    <div className="container">
      ...
      <div className="row bg-white mt-3 rounded-2 p-4 justify-content-around">
        ...
        <div className="col-md-6 col-lg-6 border border-1 rounded-3 p-4 h-100">
          <h3>Product Descriptiopn</h3>
          <span class="badge rounded-pill text-warning border border-warning">
            Disponibilidad 142
          </span>
          <h2 className="mt-3">$30000</h2>
          <p className="text-success"> <i class="fa-solid fa-truck-fast"></i> Envío acordado con el vendedor</p>
